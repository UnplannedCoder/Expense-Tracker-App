          ...
          <>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center space-x-2.5">
                          <div
                            className={`p-2 rounded-lg ${tx.type === "income" ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" : "bg-rose-500/10 text-rose-600 dark:text-rose-400"}`}
                          >
                            <IconHelper
                              name={
                                tx.type === "income"
                      ...
                      <td
                        className={`px-6 py-4 text-right whitespace-nowrap font-bold ${tx.type === "income" ? "text-emerald-600 dark:text-emerald-400" : "text-rose-600"}`}
                      >
                        {tx.type === "income" ? "+" : "−"}{" "}
            ...
            <div className="md:hidden divide-y divide-slate-100 dark:divide-slate-800">
              {transactions.map((tx) => (
                <div
                  key={tx._id}
                  className="flex items-center justify-between px-4 py-3.5 hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition"
                >
                  ...
                  <div className="flex items-center space-x-3 flex-shrink-0 ml-2">
                    <span
                      className={`font-bold text-sm ${tx.type === "income" ? "text-emerald-600 dark:text-emerald-400" : "text-rose-600"}`}
                    >
                      {tx.type === "income" ? "+" : "−"}
                      {formatMoney(tx.amount)}
                    </span>
          ...
          <div className="w-full sm:max-w-lg bg-white dark:bg-slate-900 rounded-t-2xl sm:rounded-2xl shadow-xl border border-slate-300 dark:border-slate-800 animate-fade-in overflow-hidden max-h-[95vh] flex flex-col">
            ...
            <div className="px-5 py-4 border-b border-slate-300 dark:border-slate-800 flex justify-between items-center flex-shrink-0">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 p-1 text-xl leading-none"
              >
                &times;
              </button>
            </div>
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Rent, coffee, freelance payment..."
                  rows="2"
